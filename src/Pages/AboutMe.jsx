          ...
          <div className="mt-4 md:mt-0 text-left flex">
            <div className="my-auto mx-6">
              ...
              <p className="text-base lg:text-lg text-white">
                My name is Rafi Ramdhani im a junior web developer I just became
                a web dev 6 months ago im freshgraduate from MAN 2 Kota Bekasi
                im trying and learn how to be a good programmer in a future
              </p>
              <div className="mt-5 ">
                <Button>
                  <AlertDialog>
